...
function updatePseudos(){
	...
	.done(function (result){
		...
		let idCible = document.getElementById("messageAEnvoyer").dataCible;
		let boite = document.getElementById(idCible + "case");
		let pseudoAssocie = boite.firstChild.innerHTML;
		document.getElementById("barreContact").innerHTML = pseudoAssocie;
		alert(document.getElementById("barreContact").innerHTML + " s'est renommé en " + e.firstChild.innerHTML);
	})
...
function orange() {
	...
	document.getElementById("input").style.backgroundColor = "#760000";
...
function bleu () {
	...
	document.getElementById("input").style.backgroundColor = "#004EB8";
...
function vert () {
	...
	document.getElementById("input").style.backgroundColor = "#249000";
